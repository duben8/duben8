...
namespace structures
{
	...
	public:
		...
		/// <ssummary> Vrati index prvku v kolekcii std::vector. </summary>
		/// <psaram name = "vector"> vector, v ktorom sa hlada index. </param>
		/// <psaram name = "item"> Prvok, ktoreho index sa hlada. </param>
		/// <rseturns> Index prveho vyskytu prvku vo vector-e. Ak sa v nom nenachadza, vrati -1. </returns>
		//template<typename T>
